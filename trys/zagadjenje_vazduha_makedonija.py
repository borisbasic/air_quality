...
lista_gradova = ['Skopje','Kumanovo','Bitola','Gevgelija','Strumica']
...
ax.text(-0.9, 470, 'zagađenje_vazduha_region_sjeverna_makedonija_'+str(datetime.date.today().strftime("%d.%m.%Y")), color='gray', alpha=0.5, fontsize=20)
