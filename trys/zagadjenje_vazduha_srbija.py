...
ax.axhline(300,color='#660099',label='Vrlo nezdrav', alpha=0.6)
ax.axhline(500,color='#7e0023',label='Štetan po zdravlje', alpha=0.6)
ax.legend()
...
ax.text(-0.9, 470, 'zagađenje_vazduha_region_srbija_'+str(datetime.date.today().strftime("%d.%m.%Y")), color='gray', alpha=0.3, fontsize=20)
